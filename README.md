...
| Connector | 6 | `connector.connected`, `connector.disconnected`, `connector.installed`, `connector.settings_updated`, `connector.status_changed`, `connector.uninstalled` |
